...
output_file = os.path.join(current_dir, 'RIS_vdj_pairmaster_20260129.xlsx')
...
#BR codes
seqID_list = sorted([
'UTSW001','UTSW002','UTSW004','UTSW007','UTSW009',
'UTSW010','UTSW011','UTSW012','UTSW013','UTSW015','UTSW016','UTSW017','UTSW018',
'UTSW020','UTSW022','UTSW023','UTSW025','UTSW026','UTSW029',
'UTSW031','UTSW032','UTSW033','UTSW034'
...
final_df.insert(final_df.columns.get_loc('HC_sequence_alignment') + 1, 'HC_reference', '')
final_df.insert(final_df.columns.get_loc('LC_sequence_alignment') + 1, 'LC_reference', '')
