...
def list_files_in_directory(directory_path):
    """
    Returns a list of full paths to files in the specified directory.
    Only files at the top level of the directory are included.
    """
    file_list = []
...
def create_igblast_job_file(data, project_id=None, job_id_dict=None, project_name='', save=True):
    '''
    Parameters
    ----------
    data : dict
