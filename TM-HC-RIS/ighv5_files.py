...
#
# Filter sequences for just IGHV5
#
...
#out_stage = 'ighv5.mutations'

#dir = '../stats/'
#in_stage = 'gene.mutations.aa_properties'
#out_stage = 'ighv5.mutations.aa_properties'

dir = '../gt3shm/'
in_stage = 'gt3shm.mutations.aa_properties'
out_stage = 'gt3shm.ighv5.mutations.aa_properties'

#dir = '../gt3shm/'
#in_stage = 'gt3shm.mutations'
#out_stage = 'gt3shm.ighv5.mutations'

#dir = '../'
#in_stage = 'ighj6.gene.mutations.aa_properties'
#out_stage = 'ighv5.ighj6.gene.mutations.aa_properties'

#dir = '../'
#in_stage = 'ighj6.gt3shm.mutations.aa_properties'
#out_stage = 'ighv5.ighj6.gt3shm.mutations.aa_properties'
...
if (__name__=="__main__"):
    parser = argparse.ArgumentParser(description='Split files for IGHV5.')
