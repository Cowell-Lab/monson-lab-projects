...
#
# Filter sequences for just IGHV6
#
...
#out_stage = 'ighv6.mutations'

#dir = '../stats/'
#in_stage = 'gene.mutations.aa_properties'
#out_stage = 'ighv6.mutations.aa_properties'

dir = '../gt3shm/'
in_stage = 'gt3shm.mutations.aa_properties'
out_stage = 'gt3shm.ighv6.mutations.aa_properties'

#dir = '../gt3shm/'
#in_stage = 'gt3shm.mutations'
#out_stage = 'gt3shm.ighv6.mutations'

#dir = '../'
#in_stage = 'ighj6.gene.mutations.aa_properties'
#out_stage = 'ighv6.ighj6.gene.mutations.aa_properties'

#dir = '../'
#in_stage = 'ighj6.gt3shm.mutations.aa_properties'
#out_stage = 'ighv6.ighj6.gt3shm.mutations.aa_properties'
...
if (__name__=="__main__"):
    parser = argparse.ArgumentParser(description='Split files for IGHV6.')
