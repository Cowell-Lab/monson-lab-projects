...
#lib_dir = paste(data_dir, 'analysis/stats/ighj6/', sep='')
#stage = '.ighj6.gene.mutations.aa_properties'
#lib_dir = paste(data_dir, 'analysis/stats/ighj6/ighv7/', sep='')
...
#lib_dir = paste(data_dir, 'analysis/gt3shm/ighj6/', sep='')
#stage = '.ighj6.gt3shm.mutations.aa_properties'
lib_dir = paste(data_dir, 'analysis/gt3shm/ighj6/ighv7/', sep='')
