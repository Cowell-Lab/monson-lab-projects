...
#
# Filter sequences for just IGHJ5
#
...
#out_stage = 'ighv4.ighj5.mutations'
in_stage = 'gene.mutations.aa_properties'
out_stage = 'ighj5.gene.mutations.aa_properties'
#in_stage = 'gt3shm.mutations.aa_properties'
#out_stage = 'ighj5.gt3shm.mutations.aa_properties'
...
if (__name__=="__main__"):
    parser = argparse.ArgumentParser(description='Split files for IGHJ5.')
