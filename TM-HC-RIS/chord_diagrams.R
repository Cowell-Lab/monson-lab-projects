...
chord_diagram <- function(sub_dir, stage, group_name, file_prefix)
{
    ...
    liball = read.table(paste(lib_dir, group_name, stage, '.group.vj_combo.tsv',sep=''), header=T, sep='\t')
...
#     stage = '.gt3shm.mutations'
#     file_prefix = 'Fig6.gt3shm.'
# 
#     chord_diagram(local_dir, stage, group_names[i], file_prefix)
# }
