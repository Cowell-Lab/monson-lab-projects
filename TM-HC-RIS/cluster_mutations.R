...
mutationalHedgehog <- function(sub_dir, group_file, group_name, file_prefix)
{
    ...
    #lib_dir = 'vdjserver/analysis/AJL10_mutations/'
    ...
    group.muts = read.table(paste(data_dir, sub_dir, group_file, sep=''), header=T, sep=',')
    ...
    #group.muts = read.table(paste(data_dir, lib_dir, 'gene.mutations.AJL10.repertoire_group.frequency.mutational_report.csv',sep=''), header=T, sep=',')
    #group.muts = read.table(paste(data_dir, lib_dir, 'gt3shm.mutations.AJL10.repertoire_group.frequency.mutational_report.csv',sep=''), header=T, sep=',')
    ...
    p <- ggplot(data, aes(x=as.factor(id), y=value, fill=group)) +       # Note that id is a factor. If x is numeric, there is some space between the first bar
      ...
      coord_polar() + 
      geom_text(data=label_data, aes(x=id, y=-0.01, label=place, hjust=hjust), color="black",alpha=0.6, size=2.0, angle= label_data$angle, inherit.aes = FALSE ) +
      ...
      geom_text(data=base_data, aes(x = title, y = -0.08, label=group),  colour = "black", alpha=0.8, size=2, fontface="bold", inherit.aes = FALSE)
...
p <- ggplot(data, aes(x=as.factor(id), y=value, fill=group)) +       # Note that id is a factor. If x is numeric, there is some space between the first bar
  ...
  annotate("text", x = rep(max(data$id),3) + c(0.8,0.5,0.3), y = c(0.15, 0.35, 0.55), label = c("0.2", "0.4", "0.6") , color="grey", size=3 , angle=5, fontface="bold", hjust=1) +
  geom_segment(aes(x = id, y = se_start, xend = id, yend = se_end), colour = "black", alpha=1, size=0.3 , inherit.aes = FALSE ) +
  ylim(-0.5,0.65) +
  theme_minimal() +
  theme(
  ...
  coord_polar() + 
  geom_text(data=label_data, aes(x=id, y=-0.025, label=place, hjust=hjust), color="black",alpha=0.6, size=1.5, angle= label_data$angle, inherit.aes = FALSE ) +
  # Add base line information
  geom_segment(data=base_data, aes(x = start, y = -0.05, xend = end+0.5, yend = -0.05), colour = "black", alpha=0.8, size=0.6 , inherit.aes = FALSE ) +
  geom_text(data=base_data, aes(x = title, y = -0.15, label=group),  colour = "black", alpha=0.8, size=2, fontface="bold", inherit.aes = FALSE)
...
group_names = c('HC_PB_DNA', 'CIS_PB_DNA', 'RIS_PB_DNA', 'MS2025_PB_DNA', 'ADVANCING', 'STABLE', 'CORD_POS', 'CORD_NEG', 'RIS_ADVANCING', 'RIS_STABLE', 'RIS_POS', 'RIS_NEG', 'RIS_CSRHI', 'RIS_CSRLO', 'CIS_ADVANCING', 'CIS_POS', 'CIS_NEG')

for (i in 1:length(group_names)) {
    print(group_names[i])
    local_dir = 'analysis_v3/stats/'
    group_file = 'gene.mutations.repertoire_group.frequency.mutational_report.csv'
    file_prefix = 'Fig8.all.'

    mutationalHedgehog(local_dir, group_file, group_names[i], file_prefix)
}

# for (i in 1:length(group_names)) {
#     print(group_names[i])
#     local_dir = 'analysis_v3/stats_ighv1/'
#     group_file = 'ighv1.gene.mutations.aa_properties.repertoire_group.frequency.mutational_report.csv'
#     file_prefix = 'Fig8.all.ighv1.'
# 
#     mutationalHedgehog(local_dir, group_file, group_names[i], file_prefix)
# }
...
# for (i in 1:length(group_names)) {
#     print(group_names[i])
#     local_dir = 'analysis_v3/stats_ighv2/'
#     group_file = 'ighv2.gene.mutations.aa_properties.repertoire_group.frequency.mutational_report.csv'
#     file_prefix = 'Fig8.all.ighv2.'
# 
#     mutationalHedgehog(local_dir, group_file, group_names[i], file_prefix)
# }
# 
# for (i in 1:length(group_names)) {
#     print(group_names[i])
#     local_dir = 'analysis_v3/stats_ighv3/'
#     group_file = 'ighv3.gene.mutations.aa_properties.repertoire_group.frequency.mutational_report.csv'
#     file_prefix = 'Fig8.all.ighv3.'
# 
#     mutationalHedgehog(local_dir, group_file, group_names[i], file_prefix)
# }
# 
# for (i in 1:length(group_names)) {
#     print(group_names[i])
#     local_dir = 'analysis_v3/stats_ighv4/'
#     group_file = 'ighv4.mutations.aa_properties.repertoire_group.frequency.mutational_report.csv'
#     file_prefix = 'Fig8.all.ighv4.'
# 
#     mutationalHedgehog(local_dir, group_file, group_names[i], file_prefix)
# }
# 
# for (i in 1:length(group_names)) {
#     print(group_names[i])
#     local_dir = 'analysis_v3/stats_ighv5/'
#     group_file = 'ighv5.mutations.aa_properties.repertoire_group.frequency.mutational_report.csv'
#     file_prefix = 'Fig8.all.ighv5.'
# 
#     mutationalHedgehog(local_dir, group_file, group_names[i], file_prefix)
# }
# 
# for (i in 1:length(group_names)) {
#     print(group_names[i])
#     local_dir = 'analysis_v3/stats_ighv6/'
#     group_file = 'ighv6.mutations.aa_properties.repertoire_group.frequency.mutational_report.csv'
#     file_prefix = 'Fig8.all.ighv6.'
# 
#     mutationalHedgehog(local_dir, group_file, group_names[i], file_prefix)
# }
# 
# for (i in 1:length(group_names)) {
#     print(group_names[i])
#     local_dir = 'analysis_v3/stats_ighv7/'
#     group_file = 'ighv7.mutations.aa_properties.repertoire_group.frequency.mutational_report.csv'
#     file_prefix = 'Fig8.all.ighv7.'
# 
#     mutationalHedgehog(local_dir, group_file, group_names[i], file_prefix)
# }
...
#     group_file = 'gt3shm.mutations.repertoire_group.frequency.mutational_report.csv'
#     file_prefix = 'Fig8.gt3shm.'
# 
#     mutationalHedgehog(local_dir, group_file, group_names[i], file_prefix)
# }
...
# for (i in 1:length(group_names)) {
#     print(group_names[i])
#     local_dir = 'analysis_v3/gt3shm_ighv1/'
#     group_file = 'gt3shm.ighv1.mutations.aa_properties.repertoire_group.frequency.mutational_report.csv'
#     file_prefix = 'Fig8.gt3shm.ighv1.'
# 
#     mutationalHedgehog(local_dir, group_file, group_names[i], file_prefix)
# }
...
# for (i in 1:length(group_names)) {
#     print(group_names[i])
#     local_dir = 'analysis_v3/gt3shm_ighv2/'
#     group_file = 'gt3shm.ighv2.mutations.aa_properties.repertoire_group.frequency.mutational_report.csv'
#     file_prefix = 'Fig8.gt3shm.ighv2.'
# 
#     mutationalHedgehog(local_dir, group_file, group_names[i], file_prefix)
# }
# 
# for (i in 1:length(group_names)) {
#     print(group_names[i])
#     local_dir = 'analysis_v3/gt3shm_ighv3/'
#     group_file = 'gt3shm.ighv3.mutations.aa_properties.repertoire_group.frequency.mutational_report.csv'
#     file_prefix = 'Fig8.gt3shm.ighv3.'
# 
#     mutationalHedgehog(local_dir, group_file, group_names[i], file_prefix)
# }
# 
# for (i in 1:length(group_names)) {
#     print(group_names[i])
#     local_dir = 'analysis_v3/gt3shm_ighv4/'
#     group_file = 'gt3shm.ighv4.mutations.aa_properties.repertoire_group.frequency.mutational_report.csv'
#     file_prefix = 'Fig8.gt3shm.ighv4.'
# 
#     mutationalHedgehog(local_dir, group_file, group_names[i], file_prefix)
# }
# 
# for (i in 1:length(group_names)) {
#     print(group_names[i])
#     local_dir = 'analysis_v3/gt3shm_ighv5/'
#     group_file = 'gt3shm.ighv5.mutations.aa_properties.repertoire_group.frequency.mutational_report.csv'
#     file_prefix = 'Fig8.gt3shm.ighv5.'
# 
#     mutationalHedgehog(local_dir, group_file, group_names[i], file_prefix)
# }
# 
# for (i in 1:length(group_names)) {
#     print(group_names[i])
#     local_dir = 'analysis_v3/gt3shm_ighv6/'
#     group_file = 'gt3shm.ighv6.mutations.aa_properties.repertoire_group.frequency.mutational_report.csv'
#     file_prefix = 'Fig8.gt3shm.ighv6.'
# 
#     mutationalHedgehog(local_dir, group_file, group_names[i], file_prefix)
# }
# 
# for (i in 1:length(group_names)) {
#     print(group_names[i])
#     local_dir = 'analysis_v3/gt3shm_ighv7/'
#     group_file = 'gt3shm.ighv7.mutations.aa_properties.repertoire_group.frequency.mutational_report.csv'
#     file_prefix = 'Fig8.gt3shm.ighv7.'
# 
#     mutationalHedgehog(local_dir, group_file, group_names[i], file_prefix)
# }
